 ...
 */
public class Camera1NewEnumerator implements CameraEnumerator {
    private final static String                                       TAG = "Camera1NewEnumerator";
    ...
    public Camera1NewEnumerator() {
        this(true /* captureToTexture */);
    }

    public Camera1NewEnumerator(boolean captureToTexture) {
    ...
    public CameraVideoCapturer createCapturer(
        ...
        return new Camera1NewCapturer(deviceName, eventsHandler, captureToTexture);
    }
